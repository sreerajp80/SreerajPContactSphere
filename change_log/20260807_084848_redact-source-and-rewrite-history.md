...
Implements [plans/20260807_080730_redact-source-and-rewrite-history.md](../plans/20260807_080730_redact-source-and-rewrite-history.md).
Follows on from [20260807_080040_redact-pii-from-docs.md](20260807_080040_redact-pii-from-docs.md),
which covered `plans/` and `change_log/` only.
...
`plans/20260807_080730_...` (this plan itself) originally listed the real numbers and
